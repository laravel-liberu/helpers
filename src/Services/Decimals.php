...
class Decimals
{
    ...
    {
        return bcadd((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function sub($first, $second, ?int $precision = null): string
    {
        return bcsub((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function mul($first, $second, ?int $precision = null): string
    {
        return bcmul((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function div($first, $second, ?int $precision = null): string
    {
        return bcdiv((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function sqrt($operand, ?int $precision = null): string
    {
        return bcsqrt((string) $operand, $precision ?? self::$scale);
    }

    public static function pow($first, $second, ?int $precision = null): string
    {
        return bcpow((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function mod($first, $second, ?int $precision = null): string
    {
        return bcmod((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function powmod($first, $second, ?int $precision = null): string
    {
        return bcpowmod((string) $first, (string) $second, $precision ?? self::$scale);
    }

    public static function lt($first, $second, ?int $precision = null): bool
    {
        return bccomp((string) $first, (string) $second, $precision ?? self::$scale) === -1;
    }
    ...
    {
        return bccomp((string) $first, (string) $second, $precision ?? self::$scale) === 0;
    }
